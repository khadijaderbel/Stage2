...
abstract class AbstractAiContentGenerator implements AiContentGeneratorInterface
{
    ...
    /**
     * Appelle le modèle texte (multimodal si $imageData fourni).
     * Chaque fournisseur (Gemini, Groq...) implémente son propre appel API.
     */
    ...
    // ══════════════════════════════════════════════════════════
    //  LOGIQUE COMMUNE (identique à l'ancien GeminiService)
    // ══════════════════════════════════════════════════════════
    ...
    protected function ameliorerDescription(
...
PROMPT;
    ...
    protected function genererDescription(
...
PROMPT;
    ...
    //  commun à tous les fournisseurs texte)
    // ══════════════════════════════════════════════════════════
