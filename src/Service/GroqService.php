...
{
    // ⚠️ Vérifiez les noms de modèles actuels sur https://console.groq.com/docs/models
    // (les modèles disponibles chez Groq évoluent régulièrement).
    ...
    {
        // Format OpenAI-compatible : "content" peut être une simple string
        // ou un tableau de parts (texte + image) pour les modèles vision.
        if ($imageData !== null) {
        ...
        if (!$texte) {
            throw new \RuntimeException('Réponse Groq vide ou inattendue.');
        }
